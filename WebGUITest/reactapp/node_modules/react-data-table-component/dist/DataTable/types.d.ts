...
export declare type ChangePage = (page: number, totalRows: number) => void;
export declare type ChangeRowsPerPage = (currentRowsPerPage: number, currentPage: number) => void;
export declare type ColumnSortFunction<T> = (a: T, b: T) => number;
export declare type DefaultSortField = string | number | null | undefined;
...
export declare type Selector<T> = string | ((row: T, rowIndex: number) => React.ReactNode);
export declare type SortDirection = 'asc' | 'desc';
export declare type SortFunction<T> = (rows: T[], field: string, sortDirection: 'asc' | 'desc') => T[];
export declare type RowRecord = Record<string, any>;
export declare type TableProps<T = RowRecord> = {
...
export declare type Themes = 'default' | 'dark' | string | undefined;
...
export declare type Action<T> = AllRowsAction<T> | SingleRowAction<T> | MultiRowAction<T> | SortAction<T> | PaginationPageAction | PaginationRowsPerPageAction | ClearSelectedRowsAction | RowsAction<T> | {
    type: '';
};
export {};
